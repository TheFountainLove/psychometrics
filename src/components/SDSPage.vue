...
import measurementJson from '@/assets/questions/SDS.json'
...
export default {
  ...
  methods: {
    ...
    calculateScore () {
      ...
      let positiveItems = measurementJson.scaleInfo.sds.positive
      ...
      let negativeItems = measurementJson.scaleInfo.sds.negative
